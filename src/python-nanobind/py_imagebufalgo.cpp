...
#include "py_oiio.h"
// Nanobind port — mechanically converted from src/python/py_imagebufalgo.cpp
...
bool
IBA_fill(ImageBuf& dst, nb::object values_tuple, ROI roi = ROI::All(),
         int nthreads = 0)
{
...
bool
IBA_fill2(ImageBuf& dst, nb::object top_tuple, nb::object bottom_tuple,
...
bool
IBA_fill4(ImageBuf& dst, nb::object top_left_tuple, nb::object top_right_tuple,
          nb::object bottom_left_tuple, nb::object bottom_right_tuple,
          ROI roi = ROI::All(), int nthreads = 0)
{
...
ImageBuf
IBA_fill_ret(nb::object values_tuple, ROI roi, int nthreads = 0)
{
    ImageBuf result;
...
ImageBuf
IBA_fill2_ret(nb::object top_tuple, nb::object bottom_tuple, ROI roi,
              int nthreads = 0)
{
    ImageBuf result;
...
ImageBuf
IBA_fill4_ret(nb::object top_left_tuple, nb::object top_right_tuple,
              nb::object bottom_left_tuple, nb::object bottom_right_tuple,
...
IBA_checker(ImageBuf& dst, int width, int height, int depth,
            nb::object color1_tuple, nb::object color2_tuple, int xoffset,
...
ImageBuf
IBA_checker_ret(int width, int height, int depth, nb::object color1_tuple,
                nb::object color2_tuple, int xoffset, int yoffset, int zoffset,
...
bool
IBA_channels(ImageBuf& dst, const ImageBuf& src, nb::tuple channelorder_,
             nb::tuple newchannelnames_, bool shuffle_channel_names,
             int nthreads)
{
    size_t nchannels = (size_t)channelorder_.size();
    if (nchannels < 1) {
    ...
    for (size_t i = 0; i < nchannels; ++i) {
        ...
        if (nb::isinstance<nb::int_>(orderi)) {
            channelorder[i] = nb::cast<int>(orderi);
        } else if (nb::isinstance<nb::float_>(orderi)) {
            channelvalues[i] = nb::cast<float>(orderi);
        } else if (nb::isinstance<nb::str>(orderi)) {
            std::string chname(nb::cast<nb::str>(orderi).c_str());
...
ImageBuf
IBA_channels_ret(const ImageBuf& src, nb::tuple channelorder,
                 nb::tuple newchannelnames, bool shuffle_channel_names,
                 int nthreads)
{
    ImageBuf result;
...
bool
IBA_add_color(ImageBuf& dst, const ImageBuf& A, nb::object values_tuple,
              ROI roi = ROI::All(), int nthreads = 0)
{
    std::vector<float> values;
    py_to_stdvector(values, values_tuple);
...
ImageBuf
IBA_add_color_ret(const ImageBuf& A, nb::object values_tuple,
                  ROI roi = ROI::All(), int nthreads = 0)
{
    ImageBuf result;
...
bool
IBA_sub_color(ImageBuf& dst, const ImageBuf& A, nb::object values_tuple,
              ROI roi = ROI::All(), int nthreads = 0)
{
    std::vector<float> values;
    py_to_stdvector(values, values_tuple);
...
ImageBuf
IBA_sub_color_ret(const ImageBuf& A, nb::object values_tuple,
                  ROI roi = ROI::All(), int nthreads = 0)
{
    ImageBuf result;
...
bool
IBA_absdiff_color(ImageBuf& dst, const ImageBuf& A, nb::object values_tuple,
                  ROI roi = ROI::All(), int nthreads = 0)
{
    std::vector<float> values;
    py_to_stdvector(values, values_tuple);
...
ImageBuf
IBA_absdiff_color_ret(const ImageBuf& A, nb::object values_tuple,
                      ROI roi = ROI::All(), int nthreads = 0)
{
    ImageBuf result;
...
bool
IBA_mul_color(ImageBuf& dst, const ImageBuf& A, nb::object values_tuple,
              ROI roi = ROI::All(), int nthreads = 0)
{
    std::vector<float> values;
    py_to_stdvector(values, values_tuple);
...
ImageBuf
IBA_mul_color_ret(const ImageBuf& A, nb::object values_tuple,
                  ROI roi = ROI::All(), int nthreads = 0)
{
    ImageBuf result;
...
bool
IBA_div_color(ImageBuf& dst, const ImageBuf& A, nb::object values_tuple,
              ROI roi = ROI::All(), int nthreads = 0)
{
    std::vector<float> values;
    py_to_stdvector(values, values_tuple);
...
ImageBuf
IBA_div_color_ret(const ImageBuf& A, nb::object values_tuple,
                  ROI roi = ROI::All(), int nthreads = 0)
{
    ImageBuf result;
...
bool
IBA_mad_color(ImageBuf& dst, const ImageBuf& A, nb::object Bvalues_tuple,
              nb::object Cvalues_tuple, ROI roi = ROI::All(), int nthreads = 0)
{
...
bool
IBA_mad_ici(ImageBuf& dst, const ImageBuf& A, nb::object Bvalues_tuple,
...
bool
IBA_mad_cii(ImageBuf& dst, nb::object Avalues_tuple, const ImageBuf& B,
            const ImageBuf& C, ROI roi = ROI::All(), int nthreads = 0)
{
...
ImageBuf
IBA_mad_color_ret(const ImageBuf& A, nb::object Bvalues_tuple,
                  nb::object Cvalues_tuple, ROI roi = ROI::All(),
                  int nthreads = 0)
{
    ImageBuf result;
...
ImageBuf
IBA_mad_ici_ret(const ImageBuf& A, nb::object Bvalues_tuple, const ImageBuf& C,
                ROI roi = ROI::All(), int nthreads = 0)
{
    ImageBuf result;
...
ImageBuf
IBA_mad_cii_ret(nb::object Avalues_tuple, const ImageBuf& B, const ImageBuf& C,
                ROI roi = ROI::All(), int nthreads = 0)
{
...
bool
IBA_pow_color(ImageBuf& dst, const ImageBuf& A, nb::object values_tuple,
              ROI roi = ROI::All(), int nthreads = 0)
{
    std::vector<float> values;
    py_to_stdvector(values, values_tuple);
...
ImageBuf
IBA_pow_color_ret(const ImageBuf& A, nb::object values_tuple,
                  ROI roi = ROI::All(), int nthreads = 0)
{
    ImageBuf result;
...
bool
IBA_min_color(ImageBuf& dst, const ImageBuf& A, nb::object values_tuple,
              ROI roi = ROI::All(), int nthreads = 0)
{
    std::vector<float> values;
    py_to_stdvector(values, values_tuple);
...
ImageBuf
IBA_min_color_ret(const ImageBuf& A, nb::object values_tuple,
                  ROI roi = ROI::All(), int nthreads = 0)
{
    ImageBuf result;
...
bool
IBA_max_color(ImageBuf& dst, const ImageBuf& A, nb::object values_tuple,
              ROI roi = ROI::All(), int nthreads = 0)
{
    std::vector<float> values;
    py_to_stdvector(values, values_tuple);
...
ImageBuf
IBA_max_color_ret(const ImageBuf& A, nb::object values_tuple,
                  ROI roi = ROI::All(), int nthreads = 0)
{
    ImageBuf result;
...
bool
IBA_clamp(ImageBuf& dst, const ImageBuf& src, nb::object min_, nb::object max_,
...
ImageBuf
IBA_clamp_ret(const ImageBuf& src, nb::object min_, nb::object max_,
              bool clampalpha01 = false, ROI roi = ROI::All(), int nthreads = 0)
{
    ImageBuf dst;
...
IBA_channel_sum_weight(ImageBuf& dst, const ImageBuf& src,
                       nb::object weight_tuple, ROI roi = ROI::All(),
                       int nthreads = 0)
{
...
ImageBuf
IBA_channel_sum_weight_ret(const ImageBuf& src, nb::object weight_tuple,
                           ROI roi = ROI::All(), int nthreads = 0)
{
    ImageBuf result;
...
IBA_color_map_values(ImageBuf& dst, const ImageBuf& src, int srcchannel,
                     int nknots, int channels, nb::object knots_tuple,
                     ROI roi = ROI::All(), int nthreads = 0)
{
...
IBA_color_map_values_ret(const ImageBuf& src, int srcchannel, int nknots,
                         int channels, nb::object knots_tuple,
                         ROI roi = ROI::All(), int nthreads = 0)
{
    ImageBuf dst;
...
bool
IBA_contrast_remap(ImageBuf& dst, const ImageBuf& src, nb::object black_,
                   nb::object white_, nb::object min_, nb::object max_,
                   nb::object scontrast_, nb::object sthresh_,
                   ROI roi = ROI::All(), int nthreads = 0)
{
    if (!src.initialized())
        return false;
...
ImageBuf
IBA_contrast_remap_ret(const ImageBuf& src, nb::object black_,
                       nb::object white_, nb::object min_, nb::object max_,
                       nb::object scontrast_, nb::object sthresh_,
                       ROI roi = ROI::All(), int nthreads = 0)
{
...
bool
IBA_warp(ImageBuf& dst, const ImageBuf& src, nb::object values_M,
...
ImageBuf
IBA_warp_ret(const ImageBuf& src, nb::object values_M,
             const std::string& filtername = "", float filterwidth = 0.0f,
...
IBA_colormatrixtransform(ImageBuf& dst, const ImageBuf& src,
                         const nb::object& Mobj, bool unpremult = true,
                         ROI roi = ROI::All(), int nthreads = 0)
{
...
ImageBuf
IBA_colormatrixtransform_ret(const ImageBuf& src, const nb::object& Mobj,
...
nb::object
IBA_color_range_check(ImageBuf& src, const nb::object& low,
                      const nb::object& high, ROI roi, int nthreads)
{
...
bool
IBA_render_point(ImageBuf& dst, int x, int y, nb::object color_)
{
...
IBA_render_line(ImageBuf& dst, int x1, int y1, int x2, int y2,
                nb::object color_, bool skip_first_point = false)
{
    std::vector<float> color;
    py_to_stdvector(color, color_);
    color.resize(dst.nchannels(), 1.0f);
...
bool
IBA_render_box(ImageBuf& dst, int x1, int y1, int x2, int y2, nb::object color_,
               bool fill = false)
{
    std::vector<float> color;
    py_to_stdvector(color, color_);
...
IBA_demosaic_ret(const ImageBuf& src, const std::string& pattern = "",
                 ...
                 const std::string& white_balance_mode = "",
                 nb::object white_balance = nb::none(), ROI roi = ROI::All(),
                 int nthreads = 0)
{
    std::vector<float> wb;
    ...
    if (not white_balance.is_none()) {
        params.add_or_replace(
            ParamValue("white_balance", TypeFloat, wb.size(), wb.data()));
    }

    nb::gil_scoped_release gil;
    return ImageBufAlgo::demosaic(src, params, roi, nthreads);
}
             ...
             int nthreads = 0)
{
    ...
    nb::gil_scoped_release gil;
    return ImageBufAlgo::demosaic(dst, src, params, roi, nthreads);
}
...
declare_imagebufalgo(nb::module_& m)
{
    ...
    nb::enum_<ImageBufAlgo::NonFiniteFixMode>(m, "NonFiniteFixMode")
    ...
    nb::enum_<ImageBufAlgo::MakeTextureMode>(m, "MakeTextureMode")
    ...
    nb::class_<ImageBufAlgo::PixelStats>(m, "PixelStats")
        .def(nb::init<>())
        .def_ro("min", &ImageBufAlgo::PixelStats::min)
        .def_ro("max", &ImageBufAlgo::PixelStats::max)
        .def_ro("avg", &ImageBufAlgo::PixelStats::avg)
        .def_ro("stddev", &ImageBufAlgo::PixelStats::stddev)
        .def_ro("nancount", &ImageBufAlgo::PixelStats::nancount)
        .def_ro("infcount", &ImageBufAlgo::PixelStats::infcount)
        .def_ro("finitecount", &ImageBufAlgo::PixelStats::finitecount)
        .def_ro("sum", &ImageBufAlgo::PixelStats::sum)
        .def_ro("sum2", &ImageBufAlgo::PixelStats::sum2);

    nb::class_<ImageBufAlgo::CompareResults>(m, "CompareResults")
        .def(nb::init<>())
        .def_ro("meanerror", &ImageBufAlgo::CompareResults::meanerror)
        .def_ro("rms_error", &ImageBufAlgo::CompareResults::rms_error)
        .def_ro("PSNR", &ImageBufAlgo::CompareResults::PSNR)
        .def_ro("maxerror", &ImageBufAlgo::CompareResults::maxerror)
        .def_ro("maxx", &ImageBufAlgo::CompareResults::maxx)
        .def_ro("maxy", &ImageBufAlgo::CompareResults::maxy)
        .def_ro("maxz", &ImageBufAlgo::CompareResults::maxz)
        .def_ro("maxc", &ImageBufAlgo::CompareResults::maxc)
        .def_ro("nwarn", &ImageBufAlgo::CompareResults::nwarn)
        .def_ro("nfail", &ImageBufAlgo::CompareResults::nfail)
        .def_ro("error", &ImageBufAlgo::CompareResults::error);

    // Put this all inside "ImageBufAlgo"
    nb::class_<IBA_dummy>(m, "ImageBufAlgo")
        ...
        .def_static("demosaic", &IBA_demosaic, "dst"_a, "src"_a,
                    ...
                    "white_balance_mode"_a = "", "white_balance"_a = nb::none(),
                    "roi"_a = ROI::All(), "nthreads"_a = 0)

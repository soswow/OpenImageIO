...
declare_imageinput(nb::module_& m)
{
    nb::class_<ImageInput>(m, "ImageInput")
        ...
        .def_static(
            "open",
            [](const std::string& filename) -> ImageInput* {
                return ImageInput::open(filename).release();
            },
            nb::rv_policy::take_ownership, "filename"_a)
        .def_static(
            "open",
            [](const std::string& filename, const ImageSpec& config)
                -> ImageInput* {
                return ImageInput::open(filename, &config).release();
            },
            nb::rv_policy::take_ownership, "filename"_a, "config"_a)
        ...
        .def(
            ...
            [](ImageInput& self, int subimage, int miplevel, int chbegin,
               int chend, TypeDesc format) -> nb::object {
        ...
        .def(
            "read_image",
            [](ImageInput& self, TypeDesc format) -> nb::object {
        ...
        .def(
            "read_scanline",
            [](ImageInput& self, int y, int z, TypeDesc format) -> nb::object {
        ...
        .def(
            ...
            [](ImageInput& self, int subimage, int miplevel, int xbegin,
               int xend, int ybegin, int yend, int zbegin, int zend,
               int chbegin, int chend, TypeDesc format) -> nb::object {
        ...
        .def(
            ...
            "subimage"_a = 0)
        .def_prop_ro("has_error", &ImageInput::has_error)
        .def(
            "geterror",
